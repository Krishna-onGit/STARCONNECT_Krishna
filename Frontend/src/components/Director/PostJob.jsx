  ...
  const changeEventHandler = (e) => {
    ...
    if (name.startsWith("age")) {
      ...
      setInput((prev) => ({
        ...
        height: {
          ...prev.height,
          [name.replace("height", "").toLowerCase()]: value,
        },
      }));
      ...
      setInput((prev) => ({
        ...
        weight: {
          ...prev.weight,
          [name.replace("weight", "").toLowerCase()]: value,
        },
      }));
  ...
  const submitHandler = async (e) => {
    ...
    const flattenedInput = {
      ...
      auditionDetails: {
        ...
        videoRequired: input.receiveAuditionVideo || false,
      ...
      try {
        ...
        if (res.data.success) {
          ...
          setInput({
            ...
            mediaRequirement: Array.isArray(job.mediaRequirement)
              ? job.mediaRequirement
              : [],
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <DropdownMenu name="projectType">
                  <DropdownMenuTrigger asChild>
                    <Button className="w-full">
                      {input.projectType || "Select Project Type"}
                    </Button>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent>
                    {["Film", "Digital Content", "TV Series", "Theater"].map(
                      (type) => (
                        <DropdownMenuItem
                          key={type}
                          onSelect={() =>
                            setInput({ ...input, projectType: type })
                          }
                        >
                          {type}
                        </DropdownMenuItem>
              ...
              <div>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button className="w-full">
                      {input.roleType || "Select Role"}
                    </Button>
                  </DropdownMenuTrigger>
                  <DropdownMenuContent>
                    {["Lead Role", "Supporting Role", "Background Role"].map(
                      (role) => (
                        <DropdownMenuItem
                          key={role}
                          onClick={() => setInput({ ...input, roleType: role })}
                        >
                          {role}
                        </DropdownMenuItem>
                      )
                ...
                <>
                  <div>
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button className="w-full">
                          {input.subProjectType || "Select Type"}
                        </Button>
                      </DropdownMenuTrigger>
                      <DropdownMenuContent>
                        {["Feature Film", "Short Film", "Documentary Film"].map(
                          (film) => (
                            <DropdownMenuItem
                              key={film}
                              onClick={() =>
                                setInput({ ...input, subProjectType: film })
                              }
                            >
                              {film}
                            </DropdownMenuItem>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent>
                        {[
                          ...
                          "Online Skits & Comedy Shows",
                        ].map((digital) => (
                          <DropdownMenuItem
                            key={digital}
                            onClick={() =>
                              setInput({ ...input, subProjectType: digital })
                            }
                          >
                            {digital}
                          </DropdownMenuItem>
                ...
                <>
                  <div>
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button className="w-full">
                          {input.subProjectType || "Select Project Type"}
                        </Button>
                      </DropdownMenuTrigger>
                      <DropdownMenuContent>
                        {[
                          ...
                          <DropdownMenuItem
                            key={tv}
                            onClick={() =>
                              setInput({ ...input, subProjectType: tv })
                            }
                          >
                            {tv}
                          </DropdownMenuItem>
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent>
                        {[
                          ...
                          "Community Theater",
                          "Children’s Theater",
                          "Educational & School Productions",
                        ].map((theater) => (
                          <DropdownMenuItem
                            key={theater}
                            onClick={() =>
                              setInput({ ...input, subProjectType: theater })
                            }
                          >
                            {theater}
                          </DropdownMenuItem>
              ...
              <div>
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button className="w-full">
                      {Array.isArray(input.subGenres) &&
                      input.subGenres.length > 0
              ...
              <div>
                ...
                >
                  <div className="space-y-2">
                    ...
                    <Label htmlFor="day" className="pl-2">
                      Male
                    </Label>
                  </div>
                  <div className="space-y-2 pl-6">
                    <RadioGroupItem value="Female" id="Female" />
                    <Label htmlFor="week" className="pl-2">
                      Female
                    </Label>
                  </div>
                  <div className="space-y-2 pl-6">
                    <RadioGroupItem value="Other" id="Other" />
                    <Label htmlFor="month" className="pl-2">
                      Other
                    </Label>
                  </div>
                </RadioGroup>
              ...
              <div>
                ...
                <RadioGroup
                  ...
                  value={input.expectedCompletionTime}
                  onValueChange={(value) =>
                    setInput({ ...input, expectedCompletionTime: value })
                  }
                >
                  <div className="space-y-2 ">
                  ...
                  <div className="space-y-2">
                    ...
                    <Label htmlFor="more" className="pl-2">
                      More than a month
                    </Label>
                  </div>
                </RadioGroup>
