                ...
                <TableCell className="float-right cursor-pointer">
                  <Popover>
                    ...
                    <PopoverContent className="w-32">
                      ...
                      {/* Audition Video Option (Only if job is online) */}
                      {item?.JobId?.specialSubmissionAuditions === "Online" && (
                        <div
                          onClick={() =>
                            navigate(`/director/job/${item?.job._id}/auditions`)
                          }
                          className="flex w-fit items-center my-2 cursor-pointer text-blue-600"
                        >
                          <span>View Audition Video</span>
                        </div>
                      )}
                    </PopoverContent>
                  </Popover>
